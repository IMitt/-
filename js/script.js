...
if (window.location.reload) {
  ...
  sessionStorage.setItem('primaryPage', ".main-section");
  // footerPosition()
  
}

// function footerPosition() {
//   let footer = document.querySelector(sessionStorage.getItem('nowSection')).querySelector('.footer')
//   if (window.innerHeight > document.querySelector(sessionStorage.getItem('nowSection')).offsetHeight) {
  ...
  let user = [
    ...
    },
    {
      ...
      workouts: [
        {
          id: 1731609279500,
          startTime: "11.11.2024, 21:34",
          timestamp: "2024-11-14T18:34:39.500Z",
          approaches: [
            {
              id: 1731609279502,
              name: "Выпады",
        ...
        {
          id: 1731609286100,
          startTime: "14.11.2024, 21:34",
          timestamp: "2024-11-13T18:34:46.101Z",
          approaches: [
            {
              id: 1731609288563,
        ...
        {
          id: 1731609459472,
          startTime: "14.11.2024, 21:37",
          timestamp: "2024-11-12T18:37:39.472Z",
          approaches: [
            {
              id: 1731609459475,
              name: "Подъем правой ноги",
...
function findUserBySession(email) {
  ...
  userArr = JSON.parse(localStorage.getItem('userInfo')).find((u) => u.email == email);
...
function backToMain() {
  ...
  document.querySelector(sessionStorage.getItem('primaryPage')).style.display = "flex";
  sessionStorage.setItem("nowSection", ".main-section");
  sessionStorage.setItem("previousSection", "");
}
    ...
    card.addEventListener("click", (event) => {
      ...
      function createExerciseHTML(exercise, repetitions) {
        ...
        <div class="plans-section__wrapper">
          ...
          <img src="img/closed.svg" class='plans-section__closed' id="inactive" alt="">
        </div>
      </div>
    </div>
        `;
...
function goToStatus() {
  ...
  document.querySelector(
    `${sessionStorage.getItem("primaryPage")}`
  ).style.display = "none";
  statusSection.style.display = "flex";
  ...
  document.querySelectorAll(".footer__btn-3")[1].style.backgroundImage =
    "url(img/profile.svg)";
    // footerPosition()
    sessionStorage.setItem('primaryPage','.status-section')
    if (document.querySelector('.status-section').clientHeight < window.screen.height) {
      console.log(document.querySelector('.status-section').clientHeight, window.screen.width)
      document.querySelector('.footerForStatus').style.position = 'absolute'
    } else {
      console.log(document.querySelector('.status-section').clientHeight, window.screen.width)
      document.querySelector('.footerForStatus').style.position = 'sticky'
    }
}

console.log(document.querySelector('.status-section').height)
...
function goToProfile() {
  ...
  document.querySelectorAll(".footer__btn-3")[2].style.backgroundImage =
    ...
    // footerPosition()
    sessionStorage.setItem('primaryPage','.profile-section')
}
...
function createTables() {
  ...
  const headers = ["Имя", "Почта", "Доступ", "Действие"];
...
function deleteUser(userId) {
  ...
  console.log(`Пользолватель: ${userId} удален.`);
}
...
function saveWorkoutPlan() {
  ...
  console.log("Новый план:", newPlan);
